...
var PaymentInstructionsReader = class {
  ...
  * ```
  */
  async read({ naspipToken, publicKey, options }) {
...
// scripts/index.ts
async function main() {
  const naspipToken = "naspip;my-key-issuer;my-key-id;v4.public.-5HhMhIxCgUxMC41MhIDVVNEGhdQYXltZW50IGZvciBYWVogc2VydmljZSIKCghNeSBTdG9yZSJr_pMJrWKqwdmjBL9Y8VV7vNKuue9rOFKVeByeUBmgC7Yf0S4scULu01Wh7cyWub-MQZrb7rfy_fvIPdzEJwo";
  const publicKey = "k4.public.vReOu5eFs0HYCYndN_fKrJM6e_VoidRcDAyIFLAtOEg";
  ...
  console.log("Verified payment instruction:", result.payload.data.payment);
}
__name(main, "main");
